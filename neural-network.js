class NeuralNetwork {
    constructor(i_neurons, h_neurons, o_neurons) {
        ...
        this.bias_ih = new Matrix(this.h_neurons, 1);
        this.bias_ih.randomize();
        
        this.bias_ho = new Matrix(this.o_neurons, 1);
        this.bias_ho.randomize();

        this.weights_ih = new Matrix(this.h_neurons, this.i_neurons);
        this.weights_ih.randomize();

        this.weights_ho = new Matrix(this.o_neurons, this.h_neurons);
